...
render() {
    ...
    let { id,login, name, avatar_url, url, bio, repos_url,blog,created_at ,followers} = this.props.usersDetail.users || {};
    ...
    marginBottom: '-1rem'}}/>
                                <li className="col-12 d-flex  py-4 border-bottom public source">
                                        ...
                                        <div className="d-inline-block mb-1"  style={{fontSize:'13px'}}>
                                            ...
                                            <Link to={`/home/${login}/${repos_url}`} itemprop="name codeRepository" Component={UserDetails}><i className="far fa-book"></i>
                                                    {repos_url}</Link>
